 ...
 * 1.	Создать класс Лотерея, реализовать в нём методы по генерации массива случайных чисел с выигрышными номерами,
 *     и метод который определяет являются ли номера пользователя выгрышными.
 *             2.	Размер массива с выигрышными номерами, как и массива номеров от пользователя составляет
 *     5 номеров
 * 3.	Для получения номеров от пользователя использовать Сканер
 * 4.	Ограничить игровые номера от 1 до 50
 *             5.	Распечатать на консоль результат победил ли пользователь,  номера лотереи и номера
 *     введенные пользователем
 * 6.	* Для сравнения массивов НЕ использовать сортировку.
 *             7.	* Исключите повторяемость выпадающих номеров. Т.е. Номера от 1 до 50 должны выпадать
 *     только один раз
 * }
 */
public class ClassWork {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < userNumbers.length; i++) {
            ...
            if (userNumbers[i] > 5 || userNumbers[i] < 1) {
